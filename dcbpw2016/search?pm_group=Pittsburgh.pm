...
<tr>
   ...
   <td>
      <select name="pm_group" id="user-group">
         <option value="">Any</option>  <option value="Baltimore.pm">Baltimore.pm</option>  <option value="bicycle.pm">bicycle.pm</option>  <option value="bluegrass.pm">bluegrass.pm</option>  <option value="DC.pm">DC.pm</option>  <option value="NY.pm">NY.pm</option>  <option value="Philadelphia.pm">Philadelphia.pm</option>  <option value="Pittsburgh.pm" selected="selected">Pittsburgh.pm</option>  <option value="welp.pm">welp.pm</option>  </select>
   </td>
</tr>
</table>
...
<tr>
 ...
 <th>Monger group</th>  </tr>  <tr>
   <td> <a href="/dcbpw2015/user/1677">Robert Blackwell (&lrm;rblackwe&lrm;)</a>  <img src="/images/photo.png" alt="photo" title="photo" width="12" height="12" />  </td>
   <td> Pittsburgh </td>
   <td> United States </td>
   <td> <a href="http://pgh.pm.org">Pittsburgh.pm</a>  </td>  </tr>  <tr>
   <td> <strong><a href="/dcbpw2015/user/1949">Dan Wright (&lrm;ehdonhon&lrm;)</a></strong>  </td>
   <td> Pittsburgh </td>
   <td> United States </td>
