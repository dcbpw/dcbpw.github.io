...
<body>
  ...
  <div id="wrapper">
    ...
    <div id="fakepage">
      ...
      <div id="content">  <form method="POST" action="/dcbpw2015/search" id="user-search">
...
<tr>
   ...
   <td>
      <select name="country" id="user-country">
         <option value="" selected="selected">Any</option>  <option value="us">United States</option>  </select>
   </td>
</tr>
<tr>
   ...
   <td>
      <select name="pm_group" id="user-group">
         <option value="">Any</option>  <option value="Baltimore.pm">Baltimore.pm</option>  <option value="bicycle.pm">bicycle.pm</option>  <option value="bluegrass.pm">bluegrass.pm</option>  <option value="DC.pm" selected="selected">DC.pm</option>  <option value="NY.pm">NY.pm</option>  <option value="Philadelphia.pm">Philadelphia.pm</option>  <option value="Pittsburgh.pm">Pittsburgh.pm</option>  <option value="welp.pm">welp.pm</option>  </select>
   </td>
</tr>
</table>
...
<tr>
 ...
 <th>Monger group</th>  </tr>  <tr>
   <td> <strong><a href="/dcbpw2015/user/1650">Brock Wilcox (&lrm;awwaiid&lrm;)</a></strong>  <img src="/images/photo.png" alt="photo" title="photo" width="12" height="12" />  </td>
   <td> Washington, DC </td>
   <td> United States </td>
   <td> <a href="http://dc.pm.org/">DC.pm</a>  </td>  </tr>  <tr>
   <td> <strong><a href="/dcbpw2015/user/1669">Lawrence Hixson (&lrm;Larry&lrm;)</a></strong>  <img src="/images/photo.png" alt="photo" title="photo" width="12" height="12" />  </td>
   <td> Harpers Ferry, WV </td>
   <td> United States </td>
   <td> <a href="http://dc.pm.org/">DC.pm</a>  </td>  </tr>  <tr>
   <td> <strong><a href="/dcbpw2015/user/5257">Mike Burns (&lrm;lungching&lrm;)</a></strong>  </td>
   <td> Washington </td>
   <td> United States </td>
   <td> <a href="http://dc.pm.org">DC.pm</a>  </td>  </tr>  <tr>
   <td> <strong><a href="/dcbpw2015/user/8341">Joe Hourcle</a></strong>  </td>
   <td> Upper Marlboro </td>
   <td> United States </td>
   <td> <a href="http://dc.pm.org/">DC.pm, bluegrass.pm</a>  </td>  </tr>  <tr>
   <td> <strong><a href="/dcbpw2015/user/8355">Graham Ollis (&lrm;plicease&lrm;)</a></strong>  <img src="/images/photo.png" alt="photo" title="photo" width="12" height="12" />  </td>
   <td> Washington, DC </td>
   <td> United States </td>
   <td> <a href="http://dc.pm.org">DC.pm</a>  </td>  </tr>  <tr>
   <td> <strong><a href="/dcbpw2015/user/8486">Nobody</a></strong>  </td>
   <td> &nbsp;  </td>
   <td> United States </td>
   <td> <a href="http://DC.PM.org">DC.pm, bicycle.pm</a>  </td>  </tr>  <tr>
   <td> <strong><a href="/dcbpw2015/user/10444">Michael Stemle (&lrm;manchicken&lrm;)</a></strong>  </td>
   <td> Fairfax </td>
   <td> United States </td>
