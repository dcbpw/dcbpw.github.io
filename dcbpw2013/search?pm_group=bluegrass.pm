...
<tr>
   ...
   <td>
      <select name="pm_group" id="user-group">
         <option value="">Any</option>  <option value="AmsterdamX.pm">AmsterdamX.pm</option>  <option value="Austin.pm">Austin.pm</option>  <option value="Baltimore.pm">Baltimore.pm</option>  <option value="bicycle.pm">bicycle.pm</option>  <option value="bluegrass.pm" selected="selected">bluegrass.pm</option>  <option value="DC.pm">DC.pm</option>  <option value="Dresden.pm">Dresden.pm</option>  <option value="NY.pm">NY.pm</option>  <option value="Omaha.pm">Omaha.pm</option>  <option value="Philadelphia.pm">Philadelphia.pm</option>  <option value="Pittsburgh.pm">Pittsburgh.pm</option>  <option value="Tsukuba.pm">Tsukuba.pm</option>  <option value="welp.pm">welp.pm</option>  </select>
   </td>
</tr>
</table>
...
<tr>
 ...
 <th>Monger group</th>  </tr>  <tr>
   ...
   <td> United States </td>
   <td> <a href="http://dc.pm.org/">DC.pm, bluegrass.pm</a>  </td>  </tr>  </table>   <br />   </form>  </div>
