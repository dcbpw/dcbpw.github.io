...
<tr>
   ...
   <td>
      <select name="pm_group" id="user-group">
         <option value="">Any</option>  <option value="AmsterdamX.pm">AmsterdamX.pm</option>  <option value="Austin.pm">Austin.pm</option>  <option value="Baltimore.pm">Baltimore.pm</option>  <option value="bicycle.pm">bicycle.pm</option>  <option value="bluegrass.pm">bluegrass.pm</option>  <option value="DC.pm">DC.pm</option>  <option value="Dresden.pm">Dresden.pm</option>  <option value="NY.pm">NY.pm</option>  <option value="Omaha.pm">Omaha.pm</option>  <option value="Philadelphia.pm">Philadelphia.pm</option>  <option value="Pittsburgh.pm" selected="selected">Pittsburgh.pm</option>  <option value="Tsukuba.pm">Tsukuba.pm</option>  <option value="welp.pm">welp.pm</option>  </select>
   </td>
</tr>
</table>
...
<tr>
 ...
 <th>Monger group</th>  </tr>  <tr>
   <td> <strong><a href="http://dcbpw.org/dcbpw2013/user/1677">Robert Blackwell (&lrm;rblackwe&lrm;)</a></strong>  <img src="../images/photo.png" alt="photo" title="photo" width="12" height="12" />  </td>
   <td> Pittsburgh </td>
   <td> United States </td>
   <td> <a href="http://pgh.pm.org">Pittsburgh.pm</a>  </td>  </tr>  </table>   <br />   </form>  </div>
