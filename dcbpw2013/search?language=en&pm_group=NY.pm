...
<tr>
   ...
   <td>
      <select name="pm_group" id="user-group">
         <option value="">Any</option>  <option value="AmsterdamX.pm">AmsterdamX.pm</option>  <option value="Austin.pm">Austin.pm</option>  <option value="Baltimore.pm">Baltimore.pm</option>  <option value="bicycle.pm">bicycle.pm</option>  <option value="bluegrass.pm">bluegrass.pm</option>  <option value="DC.pm">DC.pm</option>  <option value="Dresden.pm">Dresden.pm</option>  <option value="NY.pm" selected="selected">NY.pm</option>  <option value="Omaha.pm">Omaha.pm</option>  <option value="Philadelphia.pm">Philadelphia.pm</option>  <option value="Pittsburgh.pm">Pittsburgh.pm</option>  <option value="Tsukuba.pm">Tsukuba.pm</option>  <option value="welp.pm">welp.pm</option>  </select>
   </td>
</tr>
</table>
...
<tr>
 ...
 <th>Monger group</th>  </tr>  <tr>
   <td> <strong><a href="http://dcbpw.org/dcbpw2013/user/1467">James E Keenan (&lrm;kid51&lrm;)</a></strong>  <img src="../images/photo.png" alt="photo" title="photo" width="12" height="12" />  </td>
   <td> Brooklyn </td>
   <td> United States </td>
   <td> NY.pm  </td>  </tr>  <tr>
   <td> <strong><a href="http://dcbpw.org/dcbpw2013/user/1641">Andrew Rodland (&lrm;hobbs&lrm;)</a></strong>  <img src="../images/photo.png" alt="photo" title="photo" width="12" height="12" />  </td>
   <td> &nbsp;  </td>
   <td> United States </td>
   <td> <a href="http://ny.pm.org">NY.pm</a>  </td>  </tr>  <tr>
   <td> <strong><a href="http://dcbpw.org/dcbpw2013/user/5149">Nova Patch (&lrm;patch&lrm;)</a></strong>  <img src="../images/photo.png" alt="photo" title="photo" width="12" height="12" />  </td>
   <td> New York, NY </td>
   <td> United States </td>
   <td> <a href="http://www.meetup.com/The-New-York-Perl-Meetup-Group/">NY.pm, bicycle.pm</a>  </td>  </tr>  <tr>
   <td> <a href="http://dcbpw.org/dcbpw2013/user/7106">Jake Goldsborough (&lrm;ducks&lrm;)</a>  </td>
   <td> Brooklyn </td>
   <td> United States </td>
   <td> NY.pm  </td>  </tr>  <tr>
   <td> <strong><a href="http://dcbpw.org/dcbpw2013/user/8467">Belden Lyman (&lrm;belden&lrm;)</a></strong>  <img src="../images/photo.png" alt="photo" title="photo" width="12" height="12" />  </td>
   <td> White Plains, NY </td>
   <td> United States </td>
   <td> NY.pm  </td>  </tr>  <tr>
   <td> <strong><a href="http://dcbpw.org/dcbpw2013/user/8617">Augustina Ragwitz (&lrm;auggy&lrm;)</a></strong>  </td>
   <td> Brooklyn </td>
   <td> United States </td>
   <td> NY.pm  </td>  </tr>  </table>   <br />   </form>  </div>
