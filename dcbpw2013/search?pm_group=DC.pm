...
<tr>
   ...
   <td>
      <select name="pm_group" id="user-group">
         <option value="">Any</option>  <option value="AmsterdamX.pm">AmsterdamX.pm</option>  <option value="Austin.pm">Austin.pm</option>  <option value="Baltimore.pm">Baltimore.pm</option>  <option value="bicycle.pm">bicycle.pm</option>  <option value="bluegrass.pm">bluegrass.pm</option>  <option value="DC.pm" selected="selected">DC.pm</option>  <option value="Dresden.pm">Dresden.pm</option>  <option value="NY.pm">NY.pm</option>  <option value="Omaha.pm">Omaha.pm</option>  <option value="Philadelphia.pm">Philadelphia.pm</option>  <option value="Pittsburgh.pm">Pittsburgh.pm</option>  <option value="Tsukuba.pm">Tsukuba.pm</option>  <option value="welp.pm">welp.pm</option>  </select>
   </td>
</tr>
</table>
...
<tr>
 ...
 <th>Monger group</th>  </tr>  <tr>
   <td> <strong><a href="http://dcbpw.org/dcbpw2013/user/1650">Brock Wilcox (&lrm;awwaiid&lrm;)</a></strong>  <img src="../images/photo.png" alt="photo" title="photo" width="12" height="12" />  </td>
   <td> Washington, DC </td>
   <td> United States </td>
   <td> <a href="http://dc.pm.org/">DC.pm</a>  </td>  </tr>  <tr>
   <td> <strong><a href="http://dcbpw.org/dcbpw2013/user/2131">Zak Zebrowski</a></strong>  <img src="../images/photo.png" alt="photo" title="photo" width="12" height="12" />  </td>
   <td> &nbsp;  </td>
   <td> United States </td>
   <td> <a href="http://dc.pm.org">DC.pm</a>  </td>  </tr>  <tr>
   <td> <strong><a href="http://dcbpw.org/dcbpw2013/user/5257">Mike Burns (&lrm;lungching&lrm;)</a></strong>  </td>
   <td> Washington </td>
   <td> United States </td>
   <td> <a href="http://dc.pm.org">DC.pm</a>  </td>  </tr>  <tr>
   <td> <strong><a href="http://dcbpw.org/dcbpw2013/user/6490">David Stoddard (&lrm;Dave&lrm;)</a></strong>  </td>
   <td> Silver Spring </td>
   <td> United States </td>
   <td> <a href="http://dc.pm.org/">DC.pm</a>  </td>  </tr>  <tr>
   <td> <strong><a href="http://dcbpw.org/dcbpw2013/user/8341">Joe Hourcle</a></strong>  </td>
   <td> Upper Marlboro </td>
   <td> United States </td>
   <td> <a href="http://dc.pm.org/">DC.pm, bluegrass.pm</a>  </td>  </tr>  <tr>
   <td> <strong><a href="http://dcbpw.org/dcbpw2013/user/8355">Graham Ollis (&lrm;plicease&lrm;)</a></strong>  <img src="../images/photo.png" alt="photo" title="photo" width="12" height="12" />  </td>
   <td> Washington, DC </td>
   <td> United States </td>
   <td> <a href="http://dc.pm.org">DC.pm</a>  </td>  </tr>  <tr>
   <td> <strong><a href="http://dcbpw.org/dcbpw2013/user/8486">Nobody</a></strong>  </td>
   <td> &nbsp;  </td>
   <td> United States </td>
   <td> <a href="http://DC.PM.org">DC.pm, bicycle.pm</a>  </td>  </tr>  <tr>
   <td> <a href="http://dcbpw.org/dcbpw2013/user/9209">Graham Ollis</a>  </td>
   <td> Olney, MD </td>
   <td> United States </td>
   <td> <a href="http://dc.pm.org/">DC.pm</a>  </td>  </tr>  <tr>
   <td> <strong><a href="http://dcbpw.org/dcbpw2013/user/9354">Guillaume Aubert</a></strong>  <img src="../images/photo.png" alt="photo" title="photo" width="12" height="12" />  </td>
   <td> Fairfax, VA </td>
   <td> United States </td>
   <td> DC.pm  </td>  </tr>  </table>   <br />   </form>  </div>
