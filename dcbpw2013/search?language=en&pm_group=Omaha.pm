...
<tr>
   ...
   <td>
      <select name="pm_group" id="user-group">
         <option value="">Any</option>  <option value="AmsterdamX.pm">AmsterdamX.pm</option>  <option value="Austin.pm">Austin.pm</option>  <option value="Baltimore.pm">Baltimore.pm</option>  <option value="bicycle.pm">bicycle.pm</option>  <option value="bluegrass.pm">bluegrass.pm</option>  <option value="DC.pm">DC.pm</option>  <option value="Dresden.pm">Dresden.pm</option>  <option value="NY.pm">NY.pm</option>  <option value="Omaha.pm" selected="selected">Omaha.pm</option>  <option value="Philadelphia.pm">Philadelphia.pm</option>  <option value="Pittsburgh.pm">Pittsburgh.pm</option>  <option value="Tsukuba.pm">Tsukuba.pm</option>  <option value="welp.pm">welp.pm</option>  </select>
   </td>
</tr>
</table>
...
<tr>
 ...
 <th>Monger group</th>  </tr>  <tr>
   <td> <strong><a href="http://dcbpw.org/dcbpw2013/user/3890">Jay Hannah (&lrm;jhannah&lrm;)</a></strong>  <img src="../images/photo.png" alt="photo" title="photo" width="12" height="12" />  </td>
   <td> Omaha </td>
   <td> United States </td>
   <td> <a href="http://omaha.pm.org">Omaha.pm</a>  </td>  </tr>  </table>   <br />   </form>  </div>
