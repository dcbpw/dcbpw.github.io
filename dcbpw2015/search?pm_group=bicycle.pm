...
<tr>
   ...
   <td>
      <select name="pm_group" id="user-group">
         <option value="">Any</option>  <option value="Baltimore.pm">Baltimore.pm</option>  <option value="bicycle.pm" selected="selected">bicycle.pm</option>  <option value="bluegrass.pm">bluegrass.pm</option>  <option value="DC.pm">DC.pm</option>  <option value="NY.pm">NY.pm</option>  <option value="Philadelphia.pm">Philadelphia.pm</option>  <option value="Pittsburgh.pm">Pittsburgh.pm</option>  <option value="welp.pm">welp.pm</option>  </select>
   </td>
</tr>
</table>
