...
<tr>
   ...
   <td>
      <select name="pm_group" id="user-group">
         <option value="">Any</option>  <option value="Baltimore.pm" selected="selected">Baltimore.pm</option>  <option value="bicycle.pm">bicycle.pm</option>  <option value="bluegrass.pm">bluegrass.pm</option>  <option value="DC.pm">DC.pm</option>  <option value="NY.pm">NY.pm</option>  <option value="Philadelphia.pm">Philadelphia.pm</option>  <option value="Pittsburgh.pm">Pittsburgh.pm</option>  <option value="welp.pm">welp.pm</option>  </select>
   </td>
</tr>
</table>
...
<tr>
 ...
 <th>Monger group</th>  </tr>  <tr>
   <td> <strong><a href="/dcbpw2015/user/1486">Bernard Simon (&lrm;Jinzang&lrm;)</a></strong>  <img src="/images/photo.png" alt="photo" title="photo" width="12" height="12" />  </td>
   <td> Parkville </td>
   <td> United States </td>
   <td> <a href="http://baltimore.pm.org/">Baltimore.pm</a>  </td>  </tr>  <tr>
   <td> <strong><a href="/dcbpw2015/user/5262">Tim Heaney (&lrm;oylenshpeegul&lrm;)</a></strong>  <img src="/images/photo.png" alt="photo" title="photo" width="12" height="12" />  </td>
   <td> Maryland </td>
   <td> United States </td>
   <td> <a href="http://baltimore.pm.org/">Baltimore.pm</a>  </td>  </tr>  <tr>
   <td> <strong><a href="/dcbpw2015/user/8484">Stephen Belcher</a></strong>  </td>
   <td> Baltimore </td>
   <td> United States </td>
