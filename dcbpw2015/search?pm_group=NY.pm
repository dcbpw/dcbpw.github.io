...
<tr>
   ...
   <td>
      <select name="pm_group" id="user-group">
         <option value="">Any</option>  <option value="Baltimore.pm">Baltimore.pm</option>  <option value="bicycle.pm">bicycle.pm</option>  <option value="bluegrass.pm">bluegrass.pm</option>  <option value="DC.pm">DC.pm</option>  <option value="NY.pm" selected="selected">NY.pm</option>  <option value="Philadelphia.pm">Philadelphia.pm</option>  <option value="Pittsburgh.pm">Pittsburgh.pm</option>  <option value="welp.pm">welp.pm</option>  </select>
   </td>
</tr>
</table>
...
<tr>
 ...
 <th>Monger group</th>  </tr>  <tr>
   <td> <strong><a href="/dcbpw2015/user/1467">James E Keenan (&lrm;kid51&lrm;)</a></strong>  <img src="/images/photo.png" alt="photo" title="photo" width="12" height="12" />  </td>
   <td> Brooklyn </td>
   <td> United States </td>
   <td> NY.pm  </td>  </tr>  <tr>
   <td> <strong><a href="/dcbpw2015/user/9326">bulk 88</a></strong>  </td>
   <td> &nbsp;  </td>
   <td> United States </td>
