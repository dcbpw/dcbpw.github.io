...
<tr>
   ...
   <td>
      <select name="pm_group" id="user-group">
         <option value="">Any</option>  <option value="Baltimore.pm">Baltimore.pm</option>  <option value="bicycle.pm">bicycle.pm</option>  <option value="bluegrass.pm">bluegrass.pm</option>  <option value="DC.pm">DC.pm</option>  <option value="NY.pm">NY.pm</option>  <option value="Philadelphia.pm" selected="selected">Philadelphia.pm</option>  <option value="Pittsburgh.pm">Pittsburgh.pm</option>  <option value="welp.pm">welp.pm</option>  </select>
   </td>
</tr>
</table>
...
<tr>
 ...
 <th>Monger group</th>  </tr>  <tr>
   <td> <strong><a href="/dcbpw2015/user/232">R Geoffrey Avery (&lrm;rGeoffrey&lrm;)</a></strong>  <img src="/images/photo.png" alt="photo" title="photo" width="12" height="12" />  </td>
   <td> Philadelphia </td>
   <td> United States </td>
   <td> <a href="http://phl.pm.org">Philadelphia.pm</a>  </td>  </tr>  <tr>
   <td> <strong><a href="/dcbpw2015/user/1691">Walt Mankowski (&lrm;waltman&lrm;)</a></strong>  <img src="/images/photo.png" alt="photo" title="photo" width="12" height="12" />  </td>
   <td> Philadelphia </td>
   <td> United States </td>
   <td> <a href="http://philadelphia.pm.org/">Philadelphia.pm</a>  </td>  </tr>  <tr>
   <td> <strong><a href="/dcbpw2015/user/7233">John Karr</a></strong>  </td>
   <td> Philadelphia </td>
   <td> United States </td>
   <td> Philadelphia.pm  </td>  </tr>  <tr>
   <td> <a href="/dcbpw2015/user/8618">Mark Gardner (&lrm;mjgardner&lrm;)</a>  <img src="/images/photo.png" alt="photo" title="photo" width="12" height="12" />  </td>
   <td> North Wales, PA </td>
   <td> United States </td>
   <td> <a href="http://philadelphia.pm.org/">Philadelphia.pm</a>  </td>  </tr>  </table>   <br />   </form>  </div>
