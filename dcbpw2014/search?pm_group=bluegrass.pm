...
<tr>
   ...
   <td>
      <select name="pm_group" id="user-group">
         <option value="">Any</option>  <option value=""></option>  <option value="ABE.pm">ABE.pm</option>  <option value="AmsterdamX.pm">AmsterdamX.pm</option>  <option value="Baltimore.pm">Baltimore.pm</option>  <option value="bicycle.pm">bicycle.pm</option>  <option value="bluegrass.pm" selected="selected">bluegrass.pm</option>  <option value="Columbus.pm">Columbus.pm</option>  <option value="Dahut.pm">Dahut.pm</option>  <option value="DC.pm">DC.pm</option>  <option value="Dresden.pm">Dresden.pm</option>  <option value="drinkers.pm">drinkers.pm</option>  <option value="Hack Salem">Hack Salem</option>  <option value="NY.pm">NY.pm</option>  <option value="Philadelphia.pm">Philadelphia.pm</option>  <option value="Pittsburgh.pm">Pittsburgh.pm</option>  <option value="welp.pm">welp.pm</option>  </select>
   </td>
</tr>
</table>
