...
<tr>
   ...
   <td>
      <select name="pm_group" id="user-group">
         <option value="">Any</option>  <option value=""></option>  <option value="ABE.pm">ABE.pm</option>  <option value="AmsterdamX.pm">AmsterdamX.pm</option>  <option value="Baltimore.pm" selected="selected">Baltimore.pm</option>  <option value="bicycle.pm">bicycle.pm</option>  <option value="bluegrass.pm">bluegrass.pm</option>  <option value="Columbus.pm">Columbus.pm</option>  <option value="Dahut.pm">Dahut.pm</option>  <option value="DC.pm">DC.pm</option>  <option value="Dresden.pm">Dresden.pm</option>  <option value="drinkers.pm">drinkers.pm</option>  <option value="Hack Salem">Hack Salem</option>  <option value="NY.pm">NY.pm</option>  <option value="Philadelphia.pm">Philadelphia.pm</option>  <option value="Pittsburgh.pm">Pittsburgh.pm</option>  <option value="welp.pm">welp.pm</option>  </select>
   </td>
</tr>
</table>
...
<tr>
 ...
 <th>Monger group</th>  </tr>  <tr>
   <td> <strong><a href="/dcbpw2014/user/1486">Bernard Simon (&lrm;Jinzang&lrm;)</a></strong>  <img src="/images/photo.png" alt="photo" title="photo" width="12" height="12" />  </td>
   <td> Parkville </td>
   <td> United States </td>
   <td> <a href="http://baltimore.pm.org/">Baltimore.pm</a>  </td>  </tr>  <tr>
   <td> <strong><a href="/dcbpw2014/user/5262">Tim Heaney (&lrm;oylenshpeegul&lrm;)</a></strong>  <img src="/images/photo.png" alt="photo" title="photo" width="12" height="12" />  </td>
   <td> Maryland </td>
   <td> United States </td>
   <td> <a href="http://baltimore.pm.org/">Baltimore.pm</a>  </td>  </tr>  <tr>
   <td> <strong><a href="/dcbpw2014/user/8453">Chris Rohlfs</a></strong>  </td>
   <td> Owings Mills </td>
   <td> United States </td>
   <td> Baltimore.pm  </td>  </tr>  <tr>
   <td> <strong><a href="/dcbpw2014/user/8484">Stephen Belcher</a></strong>  </td>
   <td> Baltimore </td>
   <td> United States </td>
